...
import { useUpdateGoal } from '@/features/strategic/hooks/use-strategic'
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <Button type="submit" form="edit-goal-form" loading={isPending}>
            Salvar
          </Button>
        </>
      }
    >
      <form id="edit-goal-form" onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
        <Input

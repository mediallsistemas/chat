...
/**
 * Consolidated dashboard for the "toda a holding" scope: cross-unit metrics,
 * charts, the units traffic-light grid, critical impediments, plans and group
 * activity. Scoped to the user's units by the backend (GLOBAL sees all).
 */

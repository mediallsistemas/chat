...
- `apps/backend/src/common/middleware/correlation-id.middleware.ts` — novo
- `apps/backend/src/app.module.ts` — registrar middleware
- `apps/backend/src/common/interceptors/transform.interceptor.ts` — incluir correlationId no log
- `apps/backend/src/common/filters/all-exceptions.filter.ts` — incluir correlationId no log e resposta

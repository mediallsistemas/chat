...
- `apps/backend/src/users/users.service.ts` — anonymizeUser(), exportUserData()
- `apps/backend/src/users/users.controller.ts` — DELETE /:userId/personal-data, GET /:userId/my-data

...
- `apps/backend/src/users/users.controller.ts` — adicionar @Roles nos endpoints
- `apps/backend/src/auth/auth.controller.ts` — adicionar GET /me e PATCH /me
- `apps/backend/src/users/users.service.ts` — adicionar searchByName() e updateProfile()

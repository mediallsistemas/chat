...
- `apps/backend/src/notifications/notifications.service.ts` — Logger + remover .catch(() => undefined)
- `apps/backend/src/jobs/*.job.ts` — Logger em todos os jobs
- `apps/backend/src/common/interceptors/transform.interceptor.ts` — log de requests lentos

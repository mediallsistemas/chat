...
- [ ] 03 — CSRF Protection
- [ ] 04 — Users Role Guard
- [ ] 05 — Global Exception Filter

### Sprint B — Observabilidade
- [ ] 06 — Health Check
- [ ] 07 — Winston Logging
- [ ] 09 — Correlation ID *(depende de 07)*
- [ ] 08 — Sentry *(depende de 05, 07, 09)*

### Sprint C — LGPD
- [ ] 13 — User Consent Model
- [ ] 14 — Anonymization *(depende de 13 e 04)*
- [ ] 15 — Data Retention *(depende de 13)*

### Sprint D — Escalabilidade
- [ ] 11 — Pagination API
- [ ] 12 — Database Indexes
- [ ] 16 — Socket Redis Adapter
- [ ] 17 — API Versioning *(atualiza api.ts — fazer depois de 03 e 09)*

### Sprint E — Frontend
- [ ] 10 — onError Mutations
- [ ] 19 — react-hook-form Migration *(depende de 10)*
- [ ] 20 — Shared Components *(depende de 19)*
- [ ] 18 — dnd-kit Migration *(independente — pode ser feito a qualquer momento)*

...
```typescript
// apps/backend/src/infrastructure/jobs/data-retention.job.ts
...
- `apps/backend/src/infrastructure/jobs/data-retention.job.ts` — novo
...
- `apps/backend/src/infrastructure/notifications/notifications.service.ts` — definir expiresAt na criação

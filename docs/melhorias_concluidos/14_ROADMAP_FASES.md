...
- [x] Botão de contato rápido no painel (ícone chat hover nos cards de unidade → /mensagens?group=)
- [x] Menções de objetivos/tarefas no chat (@[T:uuid|título] e @[O:uuid|título] com notificação ao responsável)

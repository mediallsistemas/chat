...
```typescript
// apps/backend/src/infrastructure/health/health.controller.ts
...
```typescript
// apps/backend/src/infrastructure/health/health.module.ts
...
- `apps/backend/src/infrastructure/health/health.controller.ts` — novo
- `apps/backend/src/infrastructure/health/health.module.ts` — novo

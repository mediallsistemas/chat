...
```typescript
// apps/backend/src/contexts/consents/consents.service.ts
@Injectable()
...
```typescript
// apps/backend/src/contexts/consents/consents.controller.ts
...
- `apps/backend/src/contexts/consents/consents.service.ts` — novo
- `apps/backend/src/contexts/consents/consents.controller.ts` — novo
- `apps/backend/src/contexts/consents/consents.module.ts` — novo
- `apps/backend/src/infrastructure/notifications/notifications.service.ts` — verificar consentimento antes de enviar
